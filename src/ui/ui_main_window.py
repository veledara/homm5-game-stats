...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rta_table_widget.horizontalHeader().setStretchLastSection(True)
        ...
        self.rw_table_widget.horizontalHeader().setStretchLastSection(True)
        ...
        self.hrta_table_widget.horizontalHeader().setStretchLastSection(True)
        ...
        self.xrta_table_widget.horizontalHeader().setStretchLastSection(True)
        ...
        self.frfb_table_widget.horizontalHeader().setStretchLastSection(True)
